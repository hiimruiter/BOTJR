		...
		try {
			...
			switch(command) {
				...
				case 'info':
					...
					break
				case 'blocklist':
					teks = 'CONTATOS BLOQUEADOS DE QUANDO FUI DA KAMIBLOCK KSKS :\n'
               ...
               client.sendMessage(from, '𝗕𝗥𝗨𝗫𝗜𝗡𝗛𝗢 𝗟𝗜𝗡𝗗𝗢. <- 𝗠𝗘𝗨 𝗖𝗥𝗜𝗔𝗗𝗢 𝗣𝗗𝗣!!:*',MessageType.text, { quoted: mek} )
				...
				case 'setprefix':
					...
					break
				case 'hilih':
					if (args.length < 1) return reply('𝗞𝗗 𝗢 𝗧𝗘𝗫𝗧𝗢')
				...
				case 'tiktokstalk':
					try {
						if (args.length < 1) return client.sendMessage(from, '𝗘𝗥𝗥𝗢! 𝗩𝗖 𝗡 𝗖𝗢𝗟𝗢𝗖𝗢𝗨 𝗢 𝗡𝗢𝗠𝗘 𝗗𝗘 𝗨𝗦𝗨𝗔𝗥𝗜𝗢!', text, {quoted: mek})
						...
						reply('𝗘𝗥𝗥𝗢! 𝗡𝗢𝗠𝗘 𝗗𝗘 𝗨𝗦𝗨𝗔𝗥𝗜𝗢 𝗡 𝗘𝗫𝗜𝗦𝗧𝗘 𝗢𝗨 𝗘𝗦𝗧𝗔 𝗜𝗡𝗩𝗔𝗟𝗜𝗗𝗢!!')
					}
					break
				case 'nulis':
				case 'tulis':
				...
				case 'ssweb':
					...
					if (args.length < 1) return reply('𝗘𝗥𝗥𝗢!!')
					if (!tipelist.includes(args[0])) return reply('Tipe desktop|tablet|mobile')
					if (args.length < 2) return reply('𝗘𝗥𝗥𝗢')
				...
				case 'clearall':
					...
					reply('𝗧𝗢𝗗𝗢𝗦 𝗢𝗦 𝗖𝗛𝗔𝗧𝗦 𝗙𝗢𝗥𝗔𝗠 𝗗𝗘𝗟𝗘𝗧𝗔𝗗𝗢𝗦 𝗖𝗢𝗠 𝗦𝗨𝗖𝗘𝗦𝗦𝗢:)')
					break
				case 'bc':
					if (!isOwner) return reply('𝗤𝗨𝗘𝗠 𝗘 𝗩𝗖 𝗞𝗞𝗞𝗞𝗞?')
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						reply('𝗧𝗿𝗮𝗻𝘀𝗺𝗶𝘀𝘀𝗮̃𝗼 𝗯𝗲𝗺 𝘀𝘂𝗰𝗲𝗱𝗶𝗱𝗮')
					} else {
						for (let _ of anu) {
				...
				case 'kapankah':
					...
					break
				case 'truth':
					const trut =['Pernah suka sama . aja? berapa lama?','Kalau boleh atau kalau mau, di gc/luar gc siapa yang akan kamu jadikan sahabat?(boleh beda/sma jenis)','apa ketakutan terbesar kamu?','pernah suka sama orang dan merasa orang itu suka sama kamu juga?','Siapa nama mantan pacar teman mu yang pernah kamu sukai diam diam?','pernah gak nyuri uang nyokap atau bokap? Alesanya?','hal yang bikin seneng pas lu lagi sedih apa','pernah cinta bertepuk sebelah tangan? kalo pernah sama siapa? rasanya gimana brou?','pernah jadi selingkuhan orang?','hal yang paling ditakutin','siapa orang yang paling berpengaruh kepada kehidupanmu','hal membanggakan apa yang kamu dapatkan di tahun ini','siapa orang yang bisa membuatmu sange','siapa orang yang pernah buatmu sange','(bgi yg muslim) pernah ga solat seharian?','Siapa yang paling mendekati tipe pasangan idealmu di sini','suka mabar(main bareng)sama siapa?','pernah nolak orang? alasannya kenapa?','Sebutkan kejadian yang bikin kamu sakit hati yang masih di inget','pencapaian yang udah didapet apa aja ditahun ini?','kebiasaan terburuk lo pas di sekolah apa?']
